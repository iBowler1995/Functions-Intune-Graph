function Get-IntuneDeviceLastSync {
    ...
    <#
        ...
        ===========================================================================
		.DESCRIPTION
		Retrieves the last sync time for an Intune managed device.
		...
		===========================================================================
		.EXAMPLE
		Get-IntuneDeviceLastsync -Device DESKTOP-7XH8Z <--- Retrieves last sync time for DESKTOP-7XH8Z
	#>
    ...
    $IntuneDevice.value.lastSyncDateTime
